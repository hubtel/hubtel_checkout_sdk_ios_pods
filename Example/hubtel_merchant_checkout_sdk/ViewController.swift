...
class ViewController: UIViewController {
    ...
    @objc func openCheckout(){
        let configuration = HubtelCheckoutConfiguration(merchantId: "12323", callbackUrl: "https://9cb7-154-160-1-110.ngrok-free.app/payment-callback", merchantApiKey: "ODZKUkRxbDpuiuiuiuiuiuiuiui")
