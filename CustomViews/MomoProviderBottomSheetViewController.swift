...
protocol MomoProviderSelectionDelegate: AnyObject {
    func didSelectProvider(name: String, providerId: String)
}

class MomoProviderBottomSheetViewController: UIViewController {

    weak var delegate: MomoProviderSelectionDelegate?
    ...
    @objc private func selectButtonTapped() {
        ...
        delegate?.didSelectProvider(name: selectedProvider.name, providerId: selectedProvider.id)
...
extension MomoProviderBottomSheetViewController: UITableViewDelegate, UITableViewDataSource {
