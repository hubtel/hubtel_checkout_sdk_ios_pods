...
class ViewController: UIViewController {
    ...
    @objc func openCheckout(){
        let configuration = HubtelCheckoutConfiguration(merchantId: "1234", callbackUrl: "https://9cb7-154-160-1-110.ngrok-free.app/payment-callback", merchantApiKey: "erwrwerwerwerwerwer234234ewrwerwer==")
        let purchaseInfo = PurchaseInfo(amount: 1, customerPhoneNumber: "0557788878", purchaseDescription: "This is a desc", clientReference:UUID().uuidString)
